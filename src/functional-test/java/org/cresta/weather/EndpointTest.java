...
public class EndpointTest {
    ...
    @Test
    public void shouldStoreUserData() throws JsonProcessingException {
        String body = "{'user':'1234','location':'Denver'}";

        ResponseEntity<String> response = restTemplate.postForEntity("/weather/hello", body, String.class);
